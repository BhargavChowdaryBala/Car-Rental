...
const Hero = () => {
  ...
  return (
    ...
    className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
        ...
        className='text-4xl md:text-5xl font-semibold'>Drive Your Dreams</motion.h1>


         <motion.h6 initial={{ y: 50, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 0.8, delay: 0.2 }}
        className='text-xl md:text-xl font-semibold '>Premium car rentals at affordable daily rates. Book your car in under two minutes!</motion.h6>
