...
const Banner = () => {
  return (
    <div className="flex flex-col md:flex-row md:items-start items-center justify-between  px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden">
        ...
        <div classNmae="text-white">
            <h2 className='text-3xl font-medium'>DO You Own a Luxury Car?</h2>
            <p className='mt-2'>  Monetize your vehicel effortlessly by listing it in carRental</p>
            <p className='max-w-130'> we take care of insurence , driver verification and secure payments - so you can earn passive inceom , stress-free</p>
