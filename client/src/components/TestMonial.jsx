  ...
  return (
    <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 pt-20 pb-30">
            <div className="flex flex-col justify-center items-center text-center">
                <h1 className="text-4xl md:text-[40px] font-bold">What our customers Saying</h1>
                <p className="text-sm md:text-base text-gray-500/90 mt-2 max-w-[696px]">Experience the ultimate freedom of the open road. With our self-drive car rental app, you can choose from a massive fleet of fully sanitized hatchbacks, premium sedans, and powerful SUVs right from your smartphone. No drivers, no rigid schedules, and absolutely zero hidden costs. Experience Your Journey, Your Way today!</p>
            </div>
